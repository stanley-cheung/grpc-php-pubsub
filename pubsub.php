...
namespace google\pubsub\v1 {
  ...
  class SubscriberClient extends \Grpc\BaseStub {
    ...
    public function DeleteSubscription(\google\pubsub\v1\DeleteSubscriptionRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.pubsub.v1.Subscriber/DeleteSubscription', $argument, '\google\protobuf\Empty::deserialize', $metadata, $options);
    }
    /**
    ...
    public function ModifyAckDeadline(\google\pubsub\v1\ModifyAckDeadlineRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.pubsub.v1.Subscriber/ModifyAckDeadline', $argument, '\google\protobuf\Empty::deserialize', $metadata, $options);
    }
    /**
    ...
    public function Acknowledge(\google\pubsub\v1\AcknowledgeRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.pubsub.v1.Subscriber/Acknowledge', $argument, '\google\protobuf\Empty::deserialize', $metadata, $options);
    }
    /**
    ...
    public function ModifyPushConfig(\google\pubsub\v1\ModifyPushConfigRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.pubsub.v1.Subscriber/ModifyPushConfig', $argument, '\google\protobuf\Empty::deserialize', $metadata, $options);
    }
  }
}
namespace google\pubsub\v1 {
  ...
  class PublisherClient extends \Grpc\BaseStub {
    ...
    public function DeleteTopic(\google\pubsub\v1\DeleteTopicRequest $argument, $metadata = array(), $options = array()) {
      return $this->_simpleRequest('/google.pubsub.v1.Publisher/DeleteTopic', $argument, '\google\protobuf\Empty::deserialize', $metadata, $options);
    }
  }
}
